...
public class BBRoomDTO {
	...
	private int room_week_discount;
	...
	public int getRoom_week_discount() {
		return room_week_discount;
	}
	public void setRoom_week_discount(int room_week_discount) {
		this.room_week_discount = room_week_discount;
	}
