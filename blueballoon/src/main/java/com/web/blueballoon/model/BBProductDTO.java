...
public class BBProductDTO {
	...
	public void setProd_email(String prod_email) {
	...
	public int getProd_likeCount() {
		return prod_likeCount;
	}

	public void setProd_likeCount(int prod_likeCount) {
		this.prod_likeCount = prod_likeCount;
	}
