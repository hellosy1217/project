...
public class BBPackageDTO {
	 ...
	 * 판매자 번호 pack_price : 패키지 가격(인당) pack_org_img : 이미지 원래 이름 pack_str_img : 이미지 수정
	 * 이름 pack_period : 기간 >> n-m pack_days : 패키지 전체 일 수 pack_start_date : 시작일 들
	 * pack_content : 패키지 설명 pack_place : 지역
	 */
