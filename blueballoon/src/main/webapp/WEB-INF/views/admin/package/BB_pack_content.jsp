		...
		<table class="c">
			...
			<tr>
				...
				<td><input type="text" name="pack_title"
					value="${pack.pack_title}" readonly="readonly"></td>
				<th>패키지 지역</th>
				<td><input type="text" value="${pack.pack_place}" readonly="readonly"></td>
			</tr>
			<tr>
				<th>담당 이메일</th>
				<td><input type="email" name="pack_email"
					value="${pack.pack_email}" readonly="readonly"></td>
				<th>담당 전화</th>
				<td><input type="text" name="pack_phone"
					value="${pack.pack_phone}" readonly="readonly"></td>
			</tr>
			<tr>
				<th>패키지 이미지</th>
				<td><img
				...
				<td><input type="text" name="pack_price"
					value="${pack.pack_price}" readonly="readonly"></td>
			</tr>
			<tr>
				<c:forTokens items="${pack.pack_period}" delims="," var="period"
					...
					<c:if test="${status.count eq 1}">
						...
						<td><input type="text" name="pack_period" id="fromDate"
							value="${period}" readonly="readonly"></td>
					</c:if>
			...
			<tr>
				<th>패키지 일수</th>
				<td>
				<input type="text" value="${pack.pack_days}">
				</td>
				<th>패키지 총인원</th>
				<td>
				<input type="text" value="${pack.pack_person}">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td colspan="2" align="center"><a href="BB_pack_list">목록으로</a></td>
			</tr>
		</table>
	</form>
</div>
