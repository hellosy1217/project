...
<html lang="en">
<head>
<title>BlueBalloon - My Profile</title>
<link rel="stylesheet"
	href="//cdn.tourradar.com//include/css/responsive.min.css?v=1513962178"
	type="text/css" media="all">
<link
	href="${pageContext.request.contextPath}/resources/user/member/css/profile1.css?ver=12"
...
<body class=" ">
	<div id="header-new">
		<div id="row-1">
			<div class="content">
				<div class="rh wgr">
					<a href="#" target="_blank"><div class="circle">✓</div>최고의 선택<span
						class="show1">&amp; PRICES</span></a>
				</div>
				<div class="rh wgr hide1">
					<a href="#" target="_blank"><div class="circle">✓</div>최고의 가격</a>
				</div>
				<div class="rh last wgr">
					<a href="#" target="_blank"><div class="circle">✓</div>최고의 만족</a>
				</div>
				<div id="block-7" class="hide3">
					<span
						...
						<g fill-rule="evenodd" transform="scale(3.9385)"> <g
							stroke-width="1pt"> <path
							d="M0 0h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0z"
							fill="#bd3d44"></path> <path
							d="M0 10h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0zm0 20h247v10H0z"
							fill="#fff"></path></g> <path fill="#192f5d" d="M0 0h98.8v70H0z"></path>
						<g fill="#fff"> <path
						...
						<g> <path
							d="M8.233 58.996l.9 2.767h2.908l-2.353 1.71.899 2.766-2.354-1.71-2.353 1.71.899-2.766-2.354-1.71h2.91zm16.467 0l.899 2.767h2.909l-2.353 1.71.898 2.766-2.353-1.71-2.353 1.71.898-2.766-2.353-1.71h2.909zm16.467 0l.899 2.767h2.909l-2.353 1.71.899 2.766-2.354-1.71-2.353 1.71.899-2.766-2.354-1.71h2.91zm16.466 0l.899 2.767h2.909l-2.353 1.71.899 2.766-2.354-1.71-2.353 1.71.899-2.766-2.354-1.71h2.91zm16.467 0l.899 2.767h2.909l-2.354 1.71.9 2.766-2.354-1.71-2.353 1.71.898-2.766-2.353-1.71h2.909zm16.467 0l.899 2.767h2.909l-2.354 1.71.9 2.766-2.354-1.71-2.353 1.71.898-2.766-2.353-1.71h2.909z"></path></g></g></g>
						</svg>
					</span> <span
						style="display: inline-block; float: right; font-size: 14px;">
						02 311 3006</span>
				</div>
				<div id="why_blocks">
					<div class="hidden">
      ...
      <use xmlns:xlink="http://www.w3.org/1999/xlink"
				...
				<a href="main"><div id="block-1">
						<div class="logo" style="margin-right: 0px;">
							<img
								src="https://s3.ap-northeast-2.amazonaws.com/hellosy1217.blueballoon/header/logo1.png"
								width="170" height="35" style="margin-top: 10px;">
						</div>
					</div></a>
				<div id="block-6" class="logged" data-logged="439550">
					<div class="text">
						${myMember.member_name} <span>▾</span>
					</div>
					<div id="dashboard_expand">
						<a href="member_profile"><div class="item">내 정보 보기</div></a><a
							href="member_likelist" class="compare"><div class="item">좋아요
								...
								class="item">예약관리</div> -->
						</a><a href="member_edit"><div class="item">내 정보 수정</div></a><a
							href="member_logout"><div class="item">로그아웃</div></a>
					</div>
				</div>
				<div id="block-8">
					<a href="#" class="ltext" onclick="popitup()">고객센터</a><a
						onclick="popitup()"><svg class="svg-icon-question"
							viewBox="0 0 26.037 25.994">
       <use xmlns:xlink="http://www.w3.org/1999/xlink"
								xlink:href="/images/responsive/svg/sprites.svg?v=1#svg-icon-question"></use></svg></a>
				</div>
				<div id="block-9">
					<a href="#" class="ltext svd">My Wish Lists</a>
				</div>
				<div id="cart">
					<div class="block block-empty">
						<div class="date">Your cart is empty</div>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="profile-left span12" id="block-me">
						<div id="user-image">
							<c:choose>
								<c:when test="${empty myMember.member_str_img}">
									<img
										src="https://s3.ap-northeast-2.amazonaws.com/hellosy1217.blueballoon/common/img/person.jpg">
								</c:when>
								<c:otherwise>
									<img
										src="https://s3.ap-northeast-2.amazonaws.com/bbproject2017/bb_member/${myMember.member_str_img}">
								</c:otherwise>
							</c:choose>
							<div>
						...
						<div id="user-info">
							...
							<ul id="stats">
								...
								<li>좋아요 목록
									<div>
										<a href="member_likelist">${likeCount }</a>
									</div>
								</li>
							</ul>
						</div>
 ...
 -->
					...
					<div class="profile-left span12" id="block-reviews">
						...
						등록한 후기가 없습니다!
						<div class="footer">
							<a class="multi-line-button bigb" href="#"><span
						...
						<div class="why-box">
							...
							<ul class="points">
								<li><div class="wcheckbox">✓</div>
									<div class="content">
										<a href="#" onclick="popitup()" class="text">고객센터 </a>
									</div></li>
								<li><div class="wcheckbox">✓</div>
									<div class="content">
		...
		<script type="text/javascript"
			src="//cdn.tourradar.com//include/js/responsive.min.js?v=1513962178"></script>
		<script
			src="//cdn.tourradar.com/include/pw/responsive/script.v1514452491.min.js"
			async=""></script>
		<script type="text/javascript">
