		...
		<div class="bl">
			...
			<div class="b pad hgl">
				...
				<dl class="properties">
					...
					<dd class="value age">${prod.prod_name}</dd>
					<dt class="label">지역</dt>
					<dd class="value accommodation">${prod.prod_cate}</dd>
					<dt class="label">주소</dt>
					<dd class="value">${prod.prod_detail_address}</dd>
					<dt class="label">이메일</dt>
					<dd class="value transport">${prod.prod_email}</dd>
