		...
		<div class="reg-page sign-up clearfix">
			...
			<div class="inside" style="margin-top: 30px; opacity: 100;">
				<div class="inside-w" style="min-width: 400px;">
					<form class="clearfix" action="board_update" method="POST" name="f" enctype="multipart/form-data">
						<input type="hidden" name="board_num" value="${getBoard.board_num}" />
						<div>
							<h3>후기 제목</h3>
							<input name="board_title" id="title" size="40"
								value="${getBoard.board_title}">
						</div>
						<div>
							<h3>이 곳에 만족하셨나요?</h3>
						...
						<div class="input-c" style="width: 170px; margin-top: 10px;">
							<a class="reg-page-button" href="#" onclick="f.submit()"
								id="updateBtn" style="margin-left: 117px;"><span class="title">리뷰등록</span></a>
						</div>
