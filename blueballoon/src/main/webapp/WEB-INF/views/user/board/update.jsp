...
<form action="board_update" method="POST" name="f" enctype="multipart/form-data">
			...
			<div class="form1">
				<section class="wrapper">
					<article class="arrow1 last" style="margin-bottom:40px">
						...
						<textarea name="board_content" value="${getBoard.board_content}"class="review_text"></textarea>
					</article>
